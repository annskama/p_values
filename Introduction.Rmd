...
The overall take-home message is the spikes in the distribution of p-values reported at least to some extent may be a result of questionable reporting practices.

\**The code for this project can be found [here](https://github.com/annskama/p_values)*
